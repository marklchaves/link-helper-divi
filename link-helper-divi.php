...
{	
    wp_register_script( LINK_HELPER_DIVI_PLUGIN_NAME, plugin_dir_url( __FILE__ ) . 'public/js/' . LINK_HELPER_DIVI_PLUGIN_NAME . '.js', array( 'jquery' ), LINK_HELPER_DIVI_PLUGIN_VERSION, true ); // Put in the footer ~mlc
